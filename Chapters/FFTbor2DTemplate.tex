...
%\Figref{benchmarking1} depicts average run time of \rnatwofold
...
%\Figref{benchmarking2} is an enlargement of
...
%in \Figref{benchmarking1}. By taking logarithm of run times, the
...
%(see left panel of \Figref{histogramMFPT}).
...
%The right panel of \Figref{heatmapFFTbor2D} depicts a contour
