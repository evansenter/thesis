...
For all $0 \leq x,y \leq n$, \rtwofold and \ffttwo were
...
\rtwofold \ms{-d0} obtains a value of
...
\begin{figure}[!h]
\centering
\includegraphics[width=.9\textwidth]{Figures/FFTbor2D/ffttwoProbContour.pdf}
 \caption{
