...
In \citep{lorenz}, \rnatwofold---a dynamic programming method that operates in
...
discretized by base pair distance to two input structures.
...
has been done on folding pathways.
...
formula and trigonometric addition formulas.
% Detailed proofs of
