...
from state $(0,d_0)$, corresponding to metastable structure $A$,
 to state $(d_0,0)$, corresponding to metastable structure $B$,  by
...
\begin{figure}[!tbph]
\begin{center}
%\includegraphics[width=.8\linewidth]{FIGURES/mfptsRelativeFreqsArrow}
%\includegraphics[width=.8\linewidth]{FIGURES/log_histogram_for_switch_design_using_fftbor}
\includegraphics[width=.45\linewidth]{FIGURES/log_histogram_for_switch_design_using_fftbor}
\includegraphics[width=.45\linewidth]{FIGURES/gc_content_histogram_for_real_spliced_leader_vs_switch_design}
\caption{\small
{\em (Left)}
...
\begin{figure}[!t]
\begin{center}
\includegraphics[width=.35\linewidth]{FIGURES/RNA2Dfold_ensFreeEnergy_Lcollosoma}
\hskip 1cm
\includegraphics[width=.35\linewidth]{FIGURES/RNA2Dfold_prob_Lcollosoma}
\caption{\small
2D projection of energy landscape for Spliced Leader (SL) RNA
