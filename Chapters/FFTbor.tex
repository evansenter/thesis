...
$y_0=\emZof{}{\alpha_0},\dots, y_{n-1}=\emZof{}{\alpha_{n-1}})$ and $\alpha_k = \omega^k
...
$y_1=\frac{\emZof{}{\alpha_1}}{\emZ{}},\dots, y_{n}=\frac{\emZof{}{\alpha_n-1}}{\emZ{}}$, and
...
(\ref{eqn:ajdef}) that we can compute the probabilities $p_0,\dots,p_{n-1}$
...
{\sc Input:} RNA sequence $\seq=\seqN$, and initial secondary
structure \strSt of \seq, and integer $m$. \hfill\break
{\sc Output:} Probabilities $p_k=\bfZ{k}{1,n}/\bfZ{}{}$ to $m$ significant digits for $k=0,\dots,n-1$. \hfill\break
% \mverbatim
