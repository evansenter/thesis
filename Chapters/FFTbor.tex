...
of probabilities $p_k = \bfZ{k}{1,n} / \bfZ{}{}$ \rule[-1.5ex]{0pt}{0pt} \\
{\sc Input:} & RNA sequence $\seq = \seqN$, secondary
structure \strSt of \seq, integer $m$ \rule[-1.5ex]{0pt}{0pt} \\
{\sc Output:} & Probabilities $p_k = \bfZ{k}{1,n} / \bfZ{}{}$ to $m$ significant digits for $k=0,\dots,n-1$ \rule[-1.75ex]{0pt}{0pt} \rule[-1.5ex]{0pt}{0pt} \\
\hline
\end{tabular*}
\begin{algorithmic}[1]
