...
% Finally, we give reference to the full recursions using the more accurate
% Turner energy model, which the underlying implementation actually uses.
...
Here, we compare the run time of \rnabor \cite{Freyhult.b07} and
