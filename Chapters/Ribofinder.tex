...
downstream of \treeIdx{p}{2}{l}. \\ {\em Do not permit any possible disruptive pairing
interactions 5' of the aptamer or 3' of the terminator stem.}
\item Force base pairs and unpaired regions in \treePos{t}{1}, with
the exception of \treePos{p}{1}. \\ {\em Since the aptamer structure is well
...
\begin{enumerate}
\setstretch{1.3}
\item Force base pairs and unpaired regions in \treePos{t}{2}. \\ {\em This simply
...
\item Disallow pairing downstream of \treeIdx{p}{2}{j}.
\end{enumerate}
\clearpage
