...
Tools such as Riboswitch finder \citep{bengert2004} and \ms{RiboSW}
...
\caption{Diagram of the aptamer portion of the \Bsxpt \grb, with annotations
...
T &\rightarrow \bpL U \bpR \;|\;
\bpL S\,U \bpR \;|\; \bpL T \bpR \;|\; \bpL S\,T \bpR \\
U &\rightarrow \bullet^{\theta} \;|\; U\, \bullet \\
\end{split}
\end{align}
