...
% \input{Chapters/RNAparametric}
\input{Chapters/FFTbor2D}
\input{Chapters/Hermes}
% \input{Chapters/Wrnap}
...
\bibliography{Biblio/Merged} % The references (bibliography) information are stored in the file named "Bibliography.bib"
