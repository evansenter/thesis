...
%DIF DEL single_file_beta.tex    Sat Aug  8 03:45:47 2015
%DIF ADD single_file_edits.tex   Sat Aug  8 06:28:44 2015
...
\DIFdelbegin %DIFDELCMD < \subsubsection{Detecting Aptamers with \infernal}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsubsection{Detecting aptamers with \infernal}
\DIFaddend \label{subsubsec:rfinder:infernal}
...
\DIFdelbegin %DIFDELCMD < \subsubsection{Detecting Expression Platforms with \tthp}
%DIFDELCMD < %%%
...
\DIFaddend \label{subsubsec:rfinder:tthp}
...
\DIFdelbegin %DIFDELCMD < \subsubsection{Notation for Representing Abstract RNA Shapes}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsubsection{Notation for representing abstract RNA shapes}
\DIFaddend \label{subsubsec:rfinder:shapes}
...
following, derived from \mbox{%DIFAUXCMD
\citep{fusy:2012ka}}%DIFAUXCMD
}\DIFaddend :

\begin{align}
\label{eq:rfinder:strCfg}
S \DIFaddbegin &\DIFaddend \rightarrow \DIFdelbegin \DIFdel{S\,.}\DIFdelend \DIFaddbegin \DIFadd{\bullet }\DIFaddend \;|\; \DIFdelbegin \DIFdel{.\,}\DIFdelend S \DIFdelbegin \DIFdel{\;}\DIFdelend \DIFaddbegin \DIFadd{\bullet \,}\DIFaddend |\; \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin \bpL \DIFaddend S \DIFdelbegin \DIFdel{)}\DIFdelend \DIFaddbegin \bpR \DIFaddend \;|\; \DIFdelbegin \DIFdel{SS\;|\;\epsilon
}\DIFdelend \DIFaddbegin \DIFadd{S\, }\bpL \DIFadd{S }\bpR
\DIFaddend \end{align}
...
\DIFdelbegin %DIFDELCMD < \subsubsection{Constrained Folding to Predict Switch Structures}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \subsubsection{Constrained folding to predict switch structures}
\DIFaddend \label{subsubsec:rfinder:consfold}
